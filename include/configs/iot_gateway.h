/*
 * Configuration settings for the Balboa IoT Gateway board
 *
...
#ifndef __BALBOA_IOT_GATEWAY_H
#define __BALBOA_IOT_GATEWAY_H

#define CONFIG_ARMV7		1	/* This is an ARM V7 CPU core */
#define CONFIG_CPU_RZA1	1
#define CONFIG_BOARD_LATE_INIT	1
#define CONFIG_MACH_TYPE MACH_TYPE_IOT_GATEWAY
...
#define CONFIG_BOOTCOMMAND "run xsa_boot"
...
#define CONFIG_SH_ETHER_EEPROM_ADDR	0xFA /* MAC address offset in EEPROM */
